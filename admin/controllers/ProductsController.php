<?php 
	...
	class ProductsController extends Controller
	{
		...
		public function index()
		{
			...
			//goi view
			$this->loadView("products.php",["data"=>$data,"numPage"=>$numPage]);
		}
		//edit
		public function edit()
		{
			...
			$formAction = "index.php?controller=products&action=editPost&id=$id";
			$record = $this->modelEdit($id);
			//load view
			$this->loadView("add_edit_products.php",["record"=>$record,"formAction"=>$formAction]);
		}
		//editPost
		...
		{
			//tao bien action cho form
			$formAction = "index.php?controller=products&action=addPost";
			//load view
			$this->loadView("add_edit_products.php",["formAction"=>$formAction]);
		}
		//addPost
