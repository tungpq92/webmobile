<?php 
	...
	class SlidersController extends Controller
	{
		...
		public function index()
		{
			...
			//goi view
			$this->loadView("sliders.php",["data"=>$data,"numPage"=>$numPage]);
		}
		//edit
		public function edit()
		{
			...
			$formAction = "index.php?controller=sliders&action=editPost&id=$id";
			$record = $this->modelEdit($id);
			//load view
			$this->loadView("add_edit_sliders.php",["record"=>$record,"formAction"=>$formAction]);
		}
		//editPost
		...
		{
			//tao bien action cho form
			$formAction = "index.php?controller=sliders&action=addPost";
			//load view
			$this->loadView("add_edit_sliders.php",["formAction"=>$formAction]);
		}
		//addPost
