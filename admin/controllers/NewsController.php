<?php 
	...
	class NewsController extends Controller
	{
		...
		public function index()
		{
			...
			//goi view
			$this->loadView("news.php",["data"=>$data,"numPage"=>$numPage]);
		}
		//edit
		public function edit()
		{
			...
			$formAction = "index.php?controller=news&action=editPost&id=$id";
			$record = $this->modelEdit($id);
			//load view
			$this->loadView("add_edit_news.php",["record"=>$record,"formAction"=>$formAction]);
		}
		//editPost
		...
		{
			//tao bien action cho form
			$formAction = "index.php?controller=news&action=addPost";
			//load view
			$this->loadView("add_edit_news.php",["formAction"=>$formAction]);
		}
		//addPost
